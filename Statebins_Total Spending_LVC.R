...
ggplot(CancerScrn, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "bottom", base_size = 12) +
  labs(title="Total Spending on Low-Value Cancer Screening", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
  scale_fill_continuous_sequential(name="Total Spending\n($USD in Thousands)", limits=c(1600,3800), breaks = seq(1600,3800, by = 650), palette = "Greens", labels=comma) + 
  guides(fill = guide_colourbar(barwidth = 20, barheight = .75, raster=TRUE))

##################DIAGNOSTIC & PREVENTATIVE TESTING CATEGORY##################
ggplot(DiagPrevTest, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Low-Value Diagnostic & Preventative Testing", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
  scale_fill_continuous_sequential(name="Total Spending\n($USD in Thousands)", limits=c(0,1000), breaks = seq(0,1000, by = 300), palette = "Greens", labels=comma)

##################PREOPERATIVE TESTING CATEGORY##################
ggplot(PreopTest, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Low-Value Preoperative Testing", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
  scale_fill_continuous_sequential(name="Total Spending\n($USD in Thousands)", limits=c(50,3100), breaks = seq(50,3100, by = 1000), palette = "Greens", labels=comma)

##################IMAGING CATEGORY##################
ggplot(Imaging, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Low-Value Imaging", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
...
ggplot(PreopCataract, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Preoperative Cardiac Tests for Cataract Surgeries", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
...
ggplot(Cardio, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Low-Value Cardiovascular Testing & Procedures", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
...
ggplot(Musck, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "right", base_size = 12) +
  labs(title="Total Spending on Low-Value Musculoskeletal Surgeries and Procedures", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
  scale_fill_continuous_sequential(name="Total Spending\n($USD in Thousands)", limits=c(80,2400), breaks = seq(80,2400, by = 650), palette = "Greens", labels=comma)

##########27 SERVICES AGGREGATED##########
ggplot(Agg, aes(state=STATE, fill=TotalSpend_MCR)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "bottom", base_size = 12) +
  labs(title="Total Spending on Low-Value Care Services", subtitle="2009-2019, Medicare Advantage Enrollees") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
  scale_fill_continuous_sequential(name="Total Spending\n($USD in Millions)", limits=c(1.7,20), breaks = c(3,6,9,12,15,18), palette = "Greens", labels=comma) + 
  guides(fill = guide_colourbar(barwidth = 20, barheight = .75, raster=TRUE, label.position = "top"))

##########27 INDICATED SERVICES AGGREGATED##########
ggplot(Ind, aes(state=STATE, fill=TotalSpend_OVERALL)) +
  geom_statebins(lbl_size = 4) + 
  coord_equal() + 
  theme_statebins(legend_position = "bottom", base_size = 12) +
  labs(title="Total Spending on Appropriate Cancer Screening", subtitle="2009-2019") + 
  theme(plot.title = element_text(hjust = .5, size=16, face = "bold")) +
  theme(plot.subtitle = element_text(hjust = .65, size=14)) +
